  ...
  return (
    ...
    >
      ...
      >
        <FlexBetween>
          <Typography variant="h6" gutterBottom>
            Date Joined: {formatDate(user?.results?.date_joined)}
          </Typography>
          <Typography variant="h6" gutterBottom>
            Last Login: {formatDate(user?.results?.last_login)}
          </Typography>
        </FlexBetween>
      </Box>
      <Box
        ...
        <Box display="flex" gap={2} flexWrap="wrap">
          ...
          >
            {user?.results?.groups.map((group) => (
              <>
                <ListItemButton onClick={() => handleListClick(group)}>
                  <ListItemIcon>
                    <Groups2Icon />
                  </ListItemIcon>
          ...
          >
            <>
              <ListItemButton
                onClick={() => setStaffPermissionsOpen(!staffPermissionsOpen)}
              >
                <ListItemIcon>
                  <LockOpenIcon />
                </ListItemIcon>
              ...
              <Collapse in={staffPermissionsOpen} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
